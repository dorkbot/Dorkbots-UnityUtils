...
{
    public class ZoomPanMap : MonoBehaviour
    {
        [SerializeField] [Range(1, 20)] private float _panSpeed = 1.0f;
        [SerializeField] private float _zoomSpeed = 0.25f;
        [SerializeField] [Range(0, 21)] private float zoomMax = 20;
        [SerializeField] [Range(0, 21)] private float zoomMin = 8;
